...
'20-ECCV | 20/07/04 | [PlugNet: Degradation Aware Scene Text Recognition Supervised by a Pluggable Super-Resolution Unit](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123600154.pdf) | 0.923 | 0.944 | 0.957 | 0.950 | [`*PYTORCH`](https://hub.fastgit.org/huiyang865/plugnet) <br> [`BLOG`](./paper/PlugNet.md)
